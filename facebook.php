 ...
 */
class FBCI_FacebookApiException extends Exception
{
  /**
...
class FBCI_Facebook
{
   ...
   * @throws FBCI_FacebookApiException
   */
  protected function _restserver($params) {
    ...
    if (is_array($result) && isset($result['error_code'])) {
      throw new FBCI_FacebookApiException($result);
    }
    return $result;
  }
  ...
  protected function _graph($path, $method='GET', $params=array()) {
    ...
    if (is_array($result) && isset($result['error'])) {
      $e = new FBCI_FacebookApiException($result);
  ...
  protected function makeRequest($url, $params, $ch=null) {
    ...
    $result = curl_exec($ch);
    if ($result === false) {
      $e = new FBCI_FacebookApiException(array(
